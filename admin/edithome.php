...
<title>SIPNS - Admin Edit Dashboard</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Daftar Nomor Surat</h1>
                ...
                <!-- Begin Page Content -->
                    ...
                    <!-- DataTales Example -->
					 ...
					 <div class="card shadow mb-4">
								...
								$query	= mysqli_query($connect,' SELECT * from klasifikasisurat WHERE idsurat = "'.$idsurat.'" ');
									$data  	= mysqli_fetch_array($query);
									$tgl	= $data['tgl'];
									$kd_wilayah	= $data['kd_wilayah'];
									$kd_primer	= $data['kd_primer'];
									$kd_sekunder	= $data['kd_sekunder'];
									$kd_tersier	= $data['kd_tersier'];
								...
								<div class="card-body">
                                    ...
                                    <form class="user" action="dithome.php" method="post">
                                        <div class="form-group">
								
										
                                        <div class="form-group" style="display:none;">	
											<label>ID</label>
                                            <input id="kd" type="text" name="idsurat" class="form-control form-control-user" value="<?php echo  $data['idsurat']?>"  readonly="readonly"></input>
                                        </div>
										
                                        <div class="form-group">	
											<label>Tanggal</label>
                                            <input id="kd" type="text" name="tgl" class="form-control form-control-user" value="<?php echo  $data['tgl']?>"></input>
                                        </div>
										
                                        <div class="form-group">	
											<label>Kode Wilayah</label>
                                            <input id="kd" type="text" name="kd_wilayah" class="form-control form-control-user" value="<?php echo $kd_wilayah; ?>" readonly="readonly"></input>
                                        </div>
										...
										<div class="form-group">	
											...
											<select id="kd_primer" name="kd_primer" class="slc">
												<option value="">Pilih Kode Primer</option>
													...
													?>
												<option value="<?php echo $data['kd_primer']; ?>" <?php echo $kd_primer == $data['kd_primer'] ? 'selected' : '' ?>>
                                        ...
                                        <div class="form-group">	
											...
											<option value="">Pilih Kode Sekunder</option>
													...
													?>
												<option
                                                    style="display: <?php echo $kd_primer == $data['kd_primer'] ? '' : 'none' ?>;"
                                                    id="kd_sekunder"
                                                    data-key="<?php echo $data['kd_primer']; ?>"
                                                    class="<?php echo $data['kd_primer']; ?>"
                                                    value="<?php echo $data['kd_sekunder']; ?>"
                                                    <?php echo $kd_sekunder == $data['kd_sekunder'] ? 'selected' : '' ?>
                                                >
                                        ...
                                        <div class="form-group">	
											...
											<option value="">Pilih Kode Tersier</option>
													...
													?>
												<option
                                                    style="display: <?php echo ($kd_primer == $data['kd_primer']) && ($kd_sekunder == $data['kd_sekunder']) ? '' : 'none' ?>;"
                                                    id="kd_tersier"
                                                    data-primer="<?php echo $data['kd_primer']; ?>"
                                                    data-key="<?php echo $data['kd_sekunder']; ?>"
                                                    class="<?php echo $data['kd_sekunder']; ?>"
                                                    value="<?php echo $data['kd_tersier']; ?>"
                                                    <?php echo ($kd_primer == $data['kd_primer']) && ($kd_sekunder == $data['kd_sekunder']) && ($kd_tersier == $data['kd_tersier']) ? 'selected' : '' ?>
                                                >
                                        ...
                                        <div class="form-group">	
                                            ...
                                            <input id="kd" type="text" name="nomorurut" class="form-control form-control-user" value="<?php echo $nomorurut?>"></input>
                                        </div>
                                        ...
                                        <div class="form-group">	
											<label>Tujuan</label>
                                            <input id="kd" type="text" name="tujuan" class="form-control form-control-user" value="<?php echo $tujuan ?>"></input>
                                        </div>
										
                                        <div class="form-group">	
											<label>Perihal Surat</label>
                                            <input id="kd" type="text" name="ket" class="form-control form-control-user" value="<?php echo $ket ?>"></input>
                                        </div>
										
                                        <div class="form-group" style="display:none;">	
											<label>Create by</label>
                                            <input id="kd" type="text" name="namakaryawan" class="form-control form-control-user" value="<?php echo $namakaryawan ?>"></input>
                                        </div>
										
										<input class="btn btn-primary btn-user btn-block personal" name="edit"  type="submit" value="Update"></input>
										<a class="btn btn-secondary btn-user btn-block personal" href="home.php">Cancel</a>
