...
<title>SIPNS - Admin Edit Setting</title>
                    ...
                    <!-- DataTales Example -->
					 ...
					 <div class="card shadow mb-4">
								...
								<div class="card-body">
                                    ...
                                    <form class="user" action="ditadmin.php" method="post">
                                        <div class="form-group">
								
										
                                        <div class="form-group">	
											<label>Username</label>
                                            <input id="kd" type="text" name="useradmin" class="form-control form-control-user" value="<?php echo $useradmin?>"></input>
                                        </div>
										
                                        <div class="form-group">	
											<label>Password</label>
                                            <input id="kd" type="text" name="passwordadmin" class="form-control form-control-user" value="<?php echo $passwordadmin; ?>"></input>
                                        </div>
