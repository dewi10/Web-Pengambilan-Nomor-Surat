                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group">
											...
											<?php
												include "konek.php";
												$idregis=$_SESSION['idregis'];
												$query ="SELECT * FROM registrasi WHERE idregis='$idregis'";
												$sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
												$row = mysqli_num_rows($sql); // Ambil jumlah data dari hasil eksekusi $sql
												if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
												while($data = mysqli_fetch_array($sql)){// Ambil semua data dari hasil eksekusi $sql
							       ...
							       <div class="form-group">	
                                            ...
                                            <input id="kd" type="text" name="tgl" class="form-control form-control-user" value="<?php echo  $data['nip']?>"  readonly="readonly"></input>
                                        </div>
										
                                        <div class="form-group">
														
											<label>Nama Karyawan</label>
                                            <input id="kd" type="text" name="kd_wilayah" class="form-control form-control-user" value="<?php echo  $data['namakaryawan']?>" readonly="readonly"></input>
											
                                        </div>
										
                                        <div class="form-group">	
											<label>Email</label>
                                            <input id="kd" type="text" name="email" class="form-control form-control-user" value=" <?php echo $data['email'] ?> " readonly="readonly"></input>
                                        </div>
                                        ...
                                        <div class="form-group">	
                                            ...
                                            <input id="kd" type="password" name="username" class="form-control form-control-user" value=" <?php echo $data['password'] ?> " readonly="readonly"></input>
                                        </div>
										
										
                                        <a href="editpersonal.php?idregis=<?php echo $data['idregis'];?>"><button name="edit" type="edit" class="btn btn-primary btn-user btn-block" value="">Edit Data Diri</button></a>
